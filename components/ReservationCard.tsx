...
export default function ReservationCard({ reservation, className }: Props) {
  const isBilateral = reservation.type === "bilateral";
  return (
    <div className={cn(
      "flex items-center gap-3 p-3 rounded-xl border border-border bg-card hover:border-brand/30 transition-colors cursor-pointer",
      className
    )}>
      <div className={cn(
